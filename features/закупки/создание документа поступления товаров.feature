...
Функционал: документ поступления товаров

Как Менеджер по закупкам я хочу
создание документа поступление товаров
чтобы оставить товар на учет 
...
// создание документа
* Открытие формы создания доументов
...
Сценарий: Специальный сценарий чтобы найти ошибку
